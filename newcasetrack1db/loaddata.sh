...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/O3GINAXWKMBKYJNM2DBPG/CAF9C064-623C-42CC-AA2B-1D0F47C01836/art/data
AST_DATA_PATH=/tmp/applifire/db/O3GINAXWKMBKYJNM2DBPG/CAF9C064-623C-42CC-AA2B-1D0F47C01836/ast/data
MYSQL=/usr/bin
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_LitigationCategory_M.csv' into table ast_LitigationCategory_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_LitigationSubCategory_M.csv' into table ast_LitigationSubCategory_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Forum_M.csv' into table ast_Forum_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Statute_M.csv' into table ast_Statute_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_UserType_M.csv' into table ast_UserType_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_UserOccupation_M.csv' into table ast_UserOccupation_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
