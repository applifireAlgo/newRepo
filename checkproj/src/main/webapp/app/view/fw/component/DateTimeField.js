 ...
 */
Ext.define('Checkproj.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Checkproj.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Checkproj.view.fw.component.DateTimePicker(o);
    },
