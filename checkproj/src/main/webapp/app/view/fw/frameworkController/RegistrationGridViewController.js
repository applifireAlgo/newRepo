Ext.define('Checkproj.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Checkproj.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Checkproj.view.console.ConsoleWindow');
