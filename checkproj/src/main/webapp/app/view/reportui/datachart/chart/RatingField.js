...
Ext.define('Checkproj.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Checkproj.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Checkproj.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
