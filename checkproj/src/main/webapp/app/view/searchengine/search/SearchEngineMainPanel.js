Ext.define('Checkproj.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Checkproj.view.searchengine.search.NorthPanel', 'Checkproj.view.searchengine.search.SearchResult','Checkproj.view.searchengine.search.SearchEngineMainPanelController'],
