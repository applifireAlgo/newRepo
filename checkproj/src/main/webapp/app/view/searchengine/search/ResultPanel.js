Ext
		.define(
				'Checkproj.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Checkproj.view.searchengine.search.SearchEngineMainPanelController','Checkproj.view.searchengine.search.PanelHeaderField' ,'Checkproj.view.searchengine.search.ReportGridView','Checkproj.view.searchengine.search.ReportChartView','Checkproj.view.searchengine.search.documentView','Checkproj.view.searchengine.search.DouMeanView','Checkproj.view.googlemaps.map.MapPanel'],
