...
Ext
		.define(
				'Checkproj.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Checkproj.view.logger.tabs.details.DetailsTab',
							'Checkproj.view.logger.tabs.fileconnector.FileConnectorTab',
							'Checkproj.view.logger.tabs.dbconnector.DBConnectorTab',
							'Checkproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Checkproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Checkproj.view.logger.LogConfigurationTabPanelController',
