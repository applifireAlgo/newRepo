 ...
 * 
 */
Ext.define('Checkproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Checkproj.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
