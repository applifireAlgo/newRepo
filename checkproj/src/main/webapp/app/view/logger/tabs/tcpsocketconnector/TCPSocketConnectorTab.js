...
Ext
		.define(
				'Checkproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Checkproj.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
