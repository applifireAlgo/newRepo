 ...
 * 
 */
Ext.define('Checkproj.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Checkproj.view.logalarm.mainscreen.AddLogAlarmController',
			'Checkproj.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Checkproj.view.logalarm.mainscreen.AppAlarmPanel',
