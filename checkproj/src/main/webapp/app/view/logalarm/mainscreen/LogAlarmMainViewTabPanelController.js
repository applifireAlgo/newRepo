 ...
 * 
 */
Ext.define('Checkproj.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Checkproj.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
