Ext.define('Checkproj.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Checkproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Checkproj.model.AddUserDataModel' ],
