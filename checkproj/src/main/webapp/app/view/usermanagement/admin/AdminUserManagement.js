Ext.define('Checkproj.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Checkproj.view.usermanagement.admin.UserPasswordReset',
	            'Checkproj.view.usermanagement.admin.AddUserDetails',
	            'Checkproj.view.usermanagement.admin.ViewUser'],
