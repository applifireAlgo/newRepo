Ext.define('Checkproj.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Checkproj.view.usermanagement.enduser.UserProfileController', 'Checkproj.view.usermanagement.admin.AddUserDetailsViewModel', 'Checkproj.model.AddUserDataModel' ],
