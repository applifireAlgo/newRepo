 ...
 * 
 */
Ext.define('Checkproj.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Checkproj.view.securityconfig.SecurityConfigController',
			'Checkproj.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
