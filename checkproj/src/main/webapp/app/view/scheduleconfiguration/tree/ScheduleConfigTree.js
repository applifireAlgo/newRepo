 ...
 * 
 */
Ext.define("Checkproj.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Checkproj.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
