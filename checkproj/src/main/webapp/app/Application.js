 ...
 */
Ext.define('Checkproj.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Checkproj.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Checkproj.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Checkproj.view.login.SessionLogin').center();
