package checkproj.app.server.service.aaaboundedcontext.authorization.aspect;
...
public class ServiceauthorizationAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.aaaboundedcontext.authorization..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
