package checkproj.app.server.service.defaultcontext.defaultdomain.aspect;
...
public class ServicedefaultdomainAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.service.defaultcontext.defaultdomain..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
