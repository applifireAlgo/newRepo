package checkproj.app.server.repository.defaultcontext.defaultdomain.aspect;
...
public class RepositorydefaultdomainAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.defaultcontext.defaultdomain..*(..))")
