package checkproj.app.server.repository.organizationboundedcontext.location.aspect;
...
public class RepositorylocationAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.location..*(..))")
