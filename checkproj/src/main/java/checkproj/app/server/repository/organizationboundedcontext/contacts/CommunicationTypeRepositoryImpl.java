...
public class CommunicationTypeRepositoryImpl extends SearchInterfaceImpl implements CommunicationTypeRepository<CommunicationType> {
    ...
    public List<CommunicationType> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType> query = emanager.createQuery("select u from CommunicationType u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationType> save(List<CommunicationType> entity) throws SpartanPersistenceException, SpartanConstraintViolationException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType s = emanager.find(checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<CommunicationType> findByCommGroupId(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType> listOfCommunicationType = query.getResultList();
    ...
    public CommunicationType findById(String commType) throws Exception, SpartanPersistenceException {
        try {
            ...
            checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType listOfCommunicationType = (checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType) query.getSingleResult();
            return listOfCommunicationType;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
