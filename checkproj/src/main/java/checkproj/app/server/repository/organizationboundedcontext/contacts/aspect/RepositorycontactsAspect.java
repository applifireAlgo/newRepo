package checkproj.app.server.repository.organizationboundedcontext.contacts.aspect;
import checkproj.app.server.repository.aspect.RepositoryAspect;
...
public class RepositorycontactsAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* checkproj.app.server.repository.organizationboundedcontext.contacts..*(..))")
