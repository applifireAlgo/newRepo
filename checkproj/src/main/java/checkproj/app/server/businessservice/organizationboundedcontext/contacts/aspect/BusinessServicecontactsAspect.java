package checkproj.app.server.businessservice.organizationboundedcontext.contacts.aspect;
...
public class BusinessServicecontactsAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.businessservice.organizationboundedcontext.contacts..*(..))")
