package checkproj.app.server.businessservice.aaaboundedcontext.authentication.aspect;
...
public class BusinessServiceauthenticationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.businessservice.aaaboundedcontext.authentication..*(..))")
