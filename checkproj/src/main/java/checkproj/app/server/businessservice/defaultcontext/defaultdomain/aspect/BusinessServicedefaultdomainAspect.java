package checkproj.app.server.businessservice.defaultcontext.defaultdomain.aspect;
...
public class BusinessServicedefaultdomainAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.businessservice.defaultcontext.defaultdomain..*(..))")
