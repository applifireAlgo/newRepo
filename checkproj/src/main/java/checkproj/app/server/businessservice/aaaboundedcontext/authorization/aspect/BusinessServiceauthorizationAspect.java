package checkproj.app.server.businessservice.aaaboundedcontext.authorization.aspect;
...
public class BusinessServiceauthorizationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.businessservice.aaaboundedcontext.authorization..*(..))")
