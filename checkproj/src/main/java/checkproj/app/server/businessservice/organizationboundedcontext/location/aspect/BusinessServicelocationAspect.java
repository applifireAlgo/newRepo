package checkproj.app.server.businessservice.organizationboundedcontext.location.aspect;
import checkproj.app.server.businessservice.aspect.BusinessAspect;
...
public class BusinessServicelocationAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* checkproj.app.server.businessservice.organizationboundedcontext.location..*(..))")
