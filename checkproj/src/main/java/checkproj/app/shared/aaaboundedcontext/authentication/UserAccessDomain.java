...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            checkproj.app.shared.aaaboundedcontext.authentication.UserAccessDomain other = (checkproj.app.shared.aaaboundedcontext.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
