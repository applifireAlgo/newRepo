package checkproj.app.shared.aaaboundedcontext.authorization;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<checkproj.app.shared.aaaboundedcontext.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            checkproj.app.shared.aaaboundedcontext.authorization.Roles other = (checkproj.app.shared.aaaboundedcontext.authorization.Roles) obj;
            if (roleId == null) {
                return false;
