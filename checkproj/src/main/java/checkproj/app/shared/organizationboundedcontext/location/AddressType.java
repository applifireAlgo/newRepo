package checkproj.app.shared.organizationboundedcontext.location;
...
public class AddressType implements Serializable, CommonEntityInterface, Comparator<AddressType> {
    ...
    public boolean equals(Object obj) {
        try {
            checkproj.app.shared.organizationboundedcontext.location.AddressType other = (checkproj.app.shared.organizationboundedcontext.location.AddressType) obj;
            if (addressTypeId == null) {
                return false;
