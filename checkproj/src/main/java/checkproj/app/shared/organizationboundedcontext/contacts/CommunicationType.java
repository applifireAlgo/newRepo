...
public class CommunicationType implements Serializable, CommonEntityInterface, Comparator<CommunicationType> {
    ...
    public boolean equals(Object obj) {
        try {
            checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType other = (checkproj.app.shared.organizationboundedcontext.contacts.CommunicationType) obj;
            if (commType == null) {
                return false;
