...
import checkproj.app.server.repository.organizationboundedcontext.contacts.ContactTypeRepository;
import checkproj.app.shared.organizationboundedcontext.contacts.ContactType;
...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        contacttype.setContactTypeDesc("7yJvnzw1WPGjIVMawRD9FcAICylaqvSBb8BEVrfs9PE7rZ8pVZ");
        contacttype.setContactType("alacwqxIrnxnZgZYMA2SJjNpyhRxGqWxzQ5SLX7DmEinJgsCl7");
        contacttype.setContactTypeIcon("EtO70vMNfcmsU48kQ41QkT5ozyDx4g5zvcGVVp8bPsJtKNPnXU");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeDesc("Go4vMVVPKdkDOurO49HobJ8X2GA8x9gFfQmtvHqrIbmv4ByrPx");
            contacttype.setVersionId(1);
            contacttype.setContactType("nmQ3uXtcwmrBRJVC0zHfoG9EbutUKLPwrb1os2zznTPPOncG6T");
            contacttype.setContactTypeIcon("D5E1vtUoqpU5wFxHFIiDdKx7FtN6JbV1nvyxiucD2XA5d9Wu2n");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "FOnWKo82p7PwzspUUIIEAHrotzxbbteQK8UPBR6EifaQDqLcmEYULMniZ2wRKqW1VIuQomUu12YSdLQBXSbyQ1JRBf7QH3YYDF9Oc8MaTtw6dNJ8oQxfZqG2JI7xXkT0r"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "p70otyKCJaO7g3OH4BZxlnrPdwGjiixHJ6ffYqIsAmxjNFDbvvdM8ljwiPBpJBGiTFm66znPiI6g46B0ztqNhKdWKfZTMsT9InVTJmraRmV2kyalD1uG4IxUvXZGfNPfu"));
