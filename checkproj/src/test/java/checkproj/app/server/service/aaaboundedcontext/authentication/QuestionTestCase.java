...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws SpartanPersistenceException, SpartanConstraintViolationException {
        ...
        question.setQuestion("adU6ox2i0d0XiNFubfsIxkQjWLUDVdoFMLsyZvXONqSKQF8ZQi");
        question.setQuestionIcon("IEgl8qilSr4Z4UMWf8JmoREazJJa3oWEphm7CK9hVbmHDiSSj1");
        question.setQuestionDetails("rKw7FRz0gf");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("jRdmLRPdUqFBrZuCIiE7NMqw2hxHP4EEYK4wlCEIor0TAqU7OT");
            question.setQuestionIcon("CFInCirjOaTz3MrfdxBExb2FaZUpOfvybvKeBhuB30J2iRUrc1");
            question.setQuestionDetails("4wQ8IMZ10R");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "6zA2OpAzO5yNRrP2aHe2GvhwQwXPBTamfTmGK3W0yevzSUMt2aMqowUFMucG6XPzL"));
