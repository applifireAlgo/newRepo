package com.app.server.service.lexmauriscontext.userprofile.aspect;
...
@Aspect
@Component
public class ServiceuserprofileAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.userprofile..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
