package com.app.server.service.lexmauriscontext.legal.aspect;
...
@Aspect
@Component
public class ServicelegalAspect extends ServiceAspect {
    ...
    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..get*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.service.lexmauriscontext.legal..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
