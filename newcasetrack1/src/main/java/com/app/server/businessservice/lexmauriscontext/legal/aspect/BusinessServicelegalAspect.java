package com.app.server.businessservice.lexmauriscontext.legal.aspect;
...
@Aspect
@Component
public class BusinessServicelegalAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.lexmauriscontext.legal..*(..))")
