package com.app.server.businessservice.lexmauriscontext.userprofile.aspect;
...
@Aspect
@Component
public class BusinessServiceuserprofileAspect extends BusinessAspect {
    ...
    @Pointcut("execution(* com.app.server.businessservice.lexmauriscontext.userprofile..*(..))")
