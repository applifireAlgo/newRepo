...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CaseInterveener Transaction table", complexity = Complexity.MEDIUM)
public interface CaseInterveenerRepository<T> extends SearchInterface {
    ...
    public List<T> findByAdvocateId(String advocateId) throws Exception, SpartanPersistenceException;

    public List<T> findByAdvCatId(String advCatId) throws Exception, SpartanPersistenceException;

    public T findById(String caseIntId) throws Exception, SpartanPersistenceException;
}
