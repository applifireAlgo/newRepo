...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for UserOccupation Master table Entity", complexity = Complexity.LOW)
public interface UserOccupationRepository<T> extends SearchInterface {
    ...
    public T findById(String occupationId) throws Exception, SpartanPersistenceException;
}
