...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CasePetitioners Transaction table", complexity = Complexity.MEDIUM)
public interface CasePetitionersRepository<T> extends SearchInterface {
    ...
    public T findById(String casePetId) throws Exception, SpartanPersistenceException;
}
