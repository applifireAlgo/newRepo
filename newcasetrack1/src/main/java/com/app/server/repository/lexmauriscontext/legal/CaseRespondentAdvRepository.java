...
public interface CaseRespondentAdvRepository<T> extends SearchInterface {
    ...
    public T findById(String caseRespId) throws Exception, SpartanPersistenceException;
}
