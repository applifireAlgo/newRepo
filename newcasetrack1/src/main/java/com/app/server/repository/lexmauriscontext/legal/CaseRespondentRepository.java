...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CaseRespondent Transaction table", complexity = Complexity.MEDIUM)
public interface CaseRespondentRepository<T> extends SearchInterface {
