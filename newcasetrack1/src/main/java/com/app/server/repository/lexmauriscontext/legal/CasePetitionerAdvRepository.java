...
public interface CasePetitionerAdvRepository<T> extends SearchInterface {
    ...
    public List<T> findByCasePetAdv(String casePetAdv) throws Exception, SpartanPersistenceException;
    ...
    public T findById(String casePetAdvId) throws Exception, SpartanPersistenceException;
}
