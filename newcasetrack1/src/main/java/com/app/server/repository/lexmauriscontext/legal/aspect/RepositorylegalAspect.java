package com.app.server.repository.lexmauriscontext.legal.aspect;
...
@Aspect
@Component
public class RepositorylegalAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.legal..*(..))")
