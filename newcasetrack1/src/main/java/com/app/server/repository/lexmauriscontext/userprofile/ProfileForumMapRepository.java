...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for ProfileForumMap Master table Entity", complexity = Complexity.LOW)
public interface ProfileForumMapRepository<T> extends SearchInterface {
    ...
    public T findById(String profileForumId) throws Exception, SpartanPersistenceException;
}
