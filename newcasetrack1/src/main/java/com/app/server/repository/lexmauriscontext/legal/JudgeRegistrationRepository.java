...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for JudgeRegistration Transaction table", complexity = Complexity.MEDIUM)
public interface JudgeRegistrationRepository<T> extends SearchInterface {
    ...
    public List<T> findByJContactId(String jContactId) throws Exception, SpartanPersistenceException;

    public List<T> findByForumId(String forumId) throws Exception, SpartanPersistenceException;

    public T findById(String judgeRegId) throws Exception, SpartanPersistenceException;
}
