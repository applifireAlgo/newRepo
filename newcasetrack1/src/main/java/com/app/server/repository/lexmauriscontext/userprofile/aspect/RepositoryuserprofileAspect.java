package com.app.server.repository.lexmauriscontext.userprofile.aspect;
...
@Aspect
@Component
public class RepositoryuserprofileAspect extends RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository.lexmauriscontext.userprofile..*(..))")
