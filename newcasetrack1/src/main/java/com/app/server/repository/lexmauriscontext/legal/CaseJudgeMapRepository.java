...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for CaseJudgeMap Transaction table", complexity = Complexity.MEDIUM)
public interface CaseJudgeMapRepository<T> extends SearchInterface {
    ...
    public List<T> findByJudgeId(String judgeId) throws Exception, SpartanPersistenceException;

    public T findById(String caseJudgeId) throws Exception, SpartanPersistenceException;
}
