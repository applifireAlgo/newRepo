...
@SourceCodeAuthorClass(createdBy = "anagha.kulkarni@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for AdvocateCategory Master table Entity", complexity = Complexity.LOW)
public interface AdvocateCategoryRepository<T> extends SearchInterface {
    ...
    public T findById(String advCatId) throws Exception, SpartanPersistenceException;
}
