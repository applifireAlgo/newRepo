...
public interface StatuteRepository<T> extends SearchInterface {
    ...
    public List<T> findByLitCategoryId(String litCategoryId) throws Exception, SpartanPersistenceException;

    public T findById(String statuteId) throws Exception, SpartanPersistenceException;
}
