 ...
 */
Ext.define('Newcasetrack1.Application', {
	...
	requires : [ "Ext.ux.BoxReorderer", "Ext.ux.CellDragDrop",
			...
			"Ext.ProgressBarWidget", "Ext.ZIndexManager","Newcasetrack1.view.databrowsercalendar.DBCalendar" ],
	...
	stores : [ 'Newcasetrack1.store.QueryCriteriaWidgetsStore' ],
	...
	try {
		...
		if (responseData.response) {
			if (responseData.response.exceptionId == 4005 && !sessionTimeOutFlag) {
				...
				var loginWindow = Ext.create('Newcasetrack1.view.login.SessionLogin').center();
