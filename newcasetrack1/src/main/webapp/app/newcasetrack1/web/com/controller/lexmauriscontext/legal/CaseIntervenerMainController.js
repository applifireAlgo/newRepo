Ext.define('Newcasetrack1.newcasetrack1.web.com.controller.lexmauriscontext.legal.CaseIntervenerMainController', {
     extend: 'Newcasetrack1.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CaseIntervenerMainController',
     init: function() {
          var form = this.view.down('#CaseIntervenerForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#CaseIntervenerTree');
               ...
               var compRef = this.view.down('#CaseIntervenerTree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#CaseIntervenerGrid');
          var tree = this.view.down('#CaseIntervenerTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#CaseIntervener');
          var grid = this.view.down('#CaseIntervenerGrid');
          var tree = this.view.down('#CaseIntervenerTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CaseIntervenerForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#CaseIntervenerTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var CaseIntervener = this.view.down('#CaseIntervenerForm');
               CaseIntervener.reset();
               var gridPanel = this.view.down('#CaseIntervenerGrid');
          ...
          var formPanel = this.getView().up().down('#CaseIntervenerForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#CaseIntervenerTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CaseIntervener').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CaseIntervenerGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
