Ext.define('Newcasetrack1.newcasetrack1.web.com.controller.lexmauriscontext.legal.CaseDetailMainController', {
     extend: 'Newcasetrack1.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CaseDetailMainController',
     init: function() {
          var form = this.view.down('#CaseDetailForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#CaseDetailTree');
               ...
               var compRef = this.view.down('#CaseDetailTree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#CaseDetailGrid');
          var tree = this.view.down('#CaseDetailTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#CaseDetail');
          var grid = this.view.down('#CaseDetailGrid');
          var tree = this.view.down('#CaseDetailTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CaseDetailForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#CaseDetailTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var CaseDetail = this.view.down('#CaseDetailForm');
               CaseDetail.reset();
               var gridPanel = this.view.down('#CaseDetailGrid');
          ...
          var formPanel = this.getView().up().down('#CaseDetailForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#CaseDetailTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CaseDetail').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CaseDetailGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
