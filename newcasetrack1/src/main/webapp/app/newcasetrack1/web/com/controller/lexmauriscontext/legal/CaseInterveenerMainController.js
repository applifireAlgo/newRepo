Ext.define('Newcasetrack1.newcasetrack1.web.com.controller.lexmauriscontext.legal.CaseInterveenerMainController', {
     extend: 'Newcasetrack1.view.fw.frameworkController.AggregateViewController',
     alias: 'controller.CaseInterveenerMainController',
     init: function() {
          var form = this.view.down('#CaseInterveenerForm');
     ...
     renderTreeGridData: function(responseData) {
          ...
          if (responseData.response.success) {
               ...
               var tree = this.view.down('#CaseInterveenerTree');
               ...
               var compRef = this.view.down('#CaseInterveenerTree');
     ...
     resetForm: function(but) {
          ...
          form.down('#saveFormButton').setText('Save');
          form.reset();
          var grid = this.view.down('#CaseInterveenerGrid');
          var tree = this.view.down('#CaseInterveenerTree');
          tree.setSelection();
          grid.setSelection();
     },
     hideDataBrowser: function() {
          var form = this.view.down('#CaseInterveener');
          var grid = this.view.down('#CaseInterveenerGrid');
          var tree = this.view.down('#CaseInterveenerTreeContainer');
     ...
     refreshMainForm: function(but, data, method) {
          var formPanel = this.view.down('#CaseInterveenerForm');
     ...
     onFilterClick: function(but, evt) {
          ...
          Ext.Ajax.request({
               ...
               failure: function(response, currentObject) {
                    ...
                    var compRef = scope.sender.view.down('#CaseInterveenerTree');
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          ...
          if (record.data.leaf) {
               var CaseInterveener = this.view.down('#CaseInterveenerForm');
               CaseInterveener.reset();
               var gridPanel = this.view.down('#CaseInterveenerGrid');
          ...
          var formPanel = this.getView().up().down('#CaseInterveenerForm');
     ...
     onGridItemClick: function(me, record, item, index, e, eOpts) {
          ...
          var treePanel = this.view.up().up().down('#CaseInterveenerTree');
     ...
     renderFormValue: function(val, me) {
          store = this.view.up().down('#CaseInterveener').down('#' + me.column.dataIndex + '').store;
     ...
     setGridData: function(data) {
          var gridStore = this.view.down('#CaseInterveenerGrid').store;
          gridStore.removeAll();
          gridStore.add(data);
