 ...
 * 
 */
Ext.define('Newcasetrack1.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Newcasetrack1.view.securityconfig.SecurityConfigController',
			'Newcasetrack1.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
