Ext.define('Newcasetrack1.view.appreportui.querycriteria.QueryCriteriaView',{
	extend : 'Ext.panel.Panel',
	requires : [ 'Newcasetrack1.view.appreportui.querycriteria.QueryCriteriaViewController' ],
