 ...
 */
Ext.define('Newcasetrack1.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Newcasetrack1.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Newcasetrack1.view.fw.component.DateTimePicker(o);
    },
