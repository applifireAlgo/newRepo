 ...
 * 
 */
Ext.define('Newcasetrack1.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Newcasetrack1.view.logger.tabs.fileconnector.FileConnectorTabController'],
