...
Ext
		.define(
				'Newcasetrack1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Newcasetrack1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
