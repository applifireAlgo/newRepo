 ...
 * 
 */
Ext.define('Newcasetrack1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Newcasetrack1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
