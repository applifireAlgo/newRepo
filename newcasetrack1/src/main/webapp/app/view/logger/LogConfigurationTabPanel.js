...
Ext
		.define(
				'Newcasetrack1.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Newcasetrack1.view.logger.tabs.details.DetailsTab',
							'Newcasetrack1.view.logger.tabs.fileconnector.FileConnectorTab',
							'Newcasetrack1.view.logger.tabs.dbconnector.DBConnectorTab',
							'Newcasetrack1.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Newcasetrack1.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Newcasetrack1.view.logger.LogConfigurationTabPanelController',
