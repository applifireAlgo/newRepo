Ext.define('Newcasetrack1.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Newcasetrack1.view.searchengine.search.NorthPanel', 'Newcasetrack1.view.searchengine.search.SearchResult','Newcasetrack1.view.searchengine.search.SearchEngineMainPanelController'],
