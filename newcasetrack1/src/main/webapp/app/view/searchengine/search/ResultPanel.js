Ext
		.define(
				'Newcasetrack1.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Newcasetrack1.view.searchengine.search.SearchEngineMainPanelController','Newcasetrack1.view.searchengine.search.PanelHeaderField' ,'Newcasetrack1.view.searchengine.search.ReportGridView','Newcasetrack1.view.searchengine.search.ReportChartView','Newcasetrack1.view.searchengine.search.documentView','Newcasetrack1.view.searchengine.search.DouMeanView','Newcasetrack1.view.googlemaps.map.MapPanel'],
