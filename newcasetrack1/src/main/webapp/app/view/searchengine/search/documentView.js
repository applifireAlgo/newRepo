Ext
		.define(
				'Newcasetrack1.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Newcasetrack1.view.searchengine.search.documentController',
							'Newcasetrack1.view.searchengine.search.RowExpander' ],
