Ext.define('Newcasetrack1.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Newcasetrack1.view.usermanagement.admin.UserPasswordReset',
	            'Newcasetrack1.view.usermanagement.admin.AddUserDetails',
	            'Newcasetrack1.view.usermanagement.admin.ViewUser'],
