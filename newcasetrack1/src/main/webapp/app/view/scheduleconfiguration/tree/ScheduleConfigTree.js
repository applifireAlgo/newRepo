 ...
 * 
 */
Ext.define("Newcasetrack1.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Newcasetrack1.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
