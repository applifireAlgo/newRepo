 ...
 * 
 */
Ext.define('Newcasetrack1.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Newcasetrack1.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
