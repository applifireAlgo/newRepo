 ...
 * 
 */
Ext.define('Newcasetrack1.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Newcasetrack1.view.logalarm.mainscreen.AddLogAlarmController',
			'Newcasetrack1.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Newcasetrack1.view.logalarm.mainscreen.AppAlarmPanel',
