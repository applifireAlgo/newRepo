Ext.define('Newcasetrack1.view.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Newcasetrack1.view.scheduler.scheduler"
		var component = Ext.create(
				"Newcasetrack1.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
