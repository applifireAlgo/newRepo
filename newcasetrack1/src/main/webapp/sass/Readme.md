...
folder are mapped to the application's root namespace, 'Newcasetrack1'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Newcasetrack1"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Newcasetrack1' in the same way
as `"Newcasetrack1/sass/src"`.
